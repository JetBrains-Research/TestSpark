package org.jetbrains.research.testspark.kotlin.test.manager
...
class KotlinTestGeneratorProvider : TestGeneratorProvider {
    override fun getTestGenerator(): TestGenerator = KotlinTestGenerator
}