...
class KotlinTestCasePanelFactory(
...
//            TODO add implementation
    ...
    private fun addTest(testSuite: TestSuiteGeneratedByLLM) {
        ...
        WriteCommandAction.runWriteCommandAction(project) {
            ...
            testCase.testName = KotlinClassBuilderHelper.getTestMethodNameFromClassWithTestCase(testCase.testName, code)
    ...
    private fun runTest(indicator: CustomProgressIndicator) {
        ...
        val newTestCase = KotlinTestProcessor(project)
            .processNewTestCase(
    ...
    private fun updateTestCaseInformation() {
        testCase.testName =
            KotlinClassBuilderHelper.getTestMethodNameFromClassWithTestCase(testCase.testName, languageTextField.document.text)
