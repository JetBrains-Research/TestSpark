...
class DescriptionTab(
    ...
    private val testSparkDescription =
        JTextPane().apply {
            isEditable = false
    ...
    private val testSparkLLMDescription =
        JTextPane().apply {
            isEditable = false
            contentType = "text/html"
            addHyperlinkListener { evt ->
    ...
    private val testSparkEvoSuiteDescription =
        JTextPane().apply {
            isEditable = false
            contentType = "text/html"
            addHyperlinkListener { evt ->
    ...
    private val testSparkKexDescription =
        JTextPane().apply {
            isEditable = false
            contentType = "text/html"
            addHyperlinkListener { evt ->
    ...
    private val testSparkDisclaimerDescription =
        JTextPane().apply {
            isEditable = false
            contentType = "text/html"
            addHyperlinkListener { evt ->
     ...
     */
    fun getContent(): JComponent = JBScrollPane(toolWindowPanel)
    ...
    private fun getCommonDescriptionText(width: Int): String =
        "<html><body style='width: ${(1.25 * width).toInt()} px;'><font face=Monochrome>" +
            ...
            "TestSpark is currently developed and maintained by <a href=https://lp.jetbrains.com/research/ictl/>" +
            "ICTL at JetBrains Research</a>.<br>" +
    ...
    private fun getLLMDescriptionText(width: Int): String =
        "<html><body style='width: ${(0.65 * width).toInt()} px;'><font face=Monochrome>" +
