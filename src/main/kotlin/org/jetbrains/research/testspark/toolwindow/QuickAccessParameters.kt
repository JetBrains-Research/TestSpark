...
class QuickAccessParameters(private val project: Project) {
    ...
    private val testSparkDescription = JTextPane().apply {
        ...
        text = "<html><body><font size=\"20\" face=\"Monochrome\">" +
            "<h1>TestSpark</h1>\n" +
            "<p>TestSpark is a plugin for generating unit tests.</p>\n" +
            "<ul>\n" +
            ...
            "</ul>\n" +
            "<p>Initially implemented by <a href=\"https://www.ciselab.nl\">CISELab</a> at <a href=\"https://se.ewi.tudelft.nl\">SERG @ TU Delft</a>, " +
            "TestSpark is currently developed and maintained by <a href=\"https://lp.jetbrains.com/research/ictl/\">ICTL at JetBrains Research</a>.</p>\n" +
            "\n" +
            "<h2> DISCLAIMER </h2>\n" +
            "<p>TestSpark is currently designed to serve as an experimental tool.</p>\n" +
            "<p>Please keep in mind that tests generated by TestSpark are meant to augment your existing test suites. " +
            "They are not meant to replace writing tests manually.</p>" +
            "</font></body></html>"
