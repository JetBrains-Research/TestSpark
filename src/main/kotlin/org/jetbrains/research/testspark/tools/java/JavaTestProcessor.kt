package org.jetbrains.research.testspark.tools.java
...
class JavaTestProcessor(
    ...
    override val testCompiler =
        TestCompilerFactory.createJavacTestCompiler(project, llmSettingsState.junitVersion, javaHomeDirectory, Language.Java)
