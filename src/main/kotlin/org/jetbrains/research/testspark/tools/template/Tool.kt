...
interface Tool {
     ...
     * @see PsiFile
     */
    fun generateTestsForClass(project: Project, psiFile: PsiFile, caretOffset: Int, fileUrl: String?, testSamplesCode: String, runnerController: RunnerController, testSparkDisplayFactory: TestSparkDisplayFactory)
     ...
     */
    fun generateTestsForMethod(project: Project, psiFile: PsiFile, caretOffset: Int, fileUrl: String?, testSamplesCode: String, runnerController: RunnerController, testSparkDisplayFactory: TestSparkDisplayFactory)
     ...
     * @see PsiFile
     */
    fun generateTestsForLine(project: Project, psiFile: PsiFile, caretOffset: Int, fileUrl: String?, testSamplesCode: String, runnerController: RunnerController, testSparkDisplayFactory: TestSparkDisplayFactory)
}
