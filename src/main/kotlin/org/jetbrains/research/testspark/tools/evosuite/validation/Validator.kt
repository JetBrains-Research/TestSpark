package org.jetbrains.research.testspark.tools.evosuite.validation
...
class Validator(
    ...
    fun validateSuite() {
        ...
        val testValidationRoot = "${FileUtilRt.getTempDirectory()}${sep}testSparkResults$sep$jobName-validation"
