...
class LLMProcessManager(
    ...
    override fun runTestGenerator(
        ...
        while (!generatedTestsArePassing) {
            ...
            val testCompiler = TestCompiler(javaHomePath, libraryPath, getJUnitVersion())
    ...
    // TODO make common with TestProcessor.getJUnitVersion() && JUnitTestsAssembler.getJUnitVersion()
