...
class LLMErrorManager : ErrorManager {
     ...
     */
    fun createRequestErrorMessage(code: Int): String = org.jetbrains.research.testspark.TestSparkBundle.message("requestError") + " " + code.toString()
    ...
    override fun errorProcess(message: String, project: Project) {
        if (project.service<ErrorService>().errorOccurred()) {
            NotificationGroupManager.getInstance()
                ...
                .createNotification(
                    org.jetbrains.research.testspark.TestSparkBundle.message("llmErrorTitle"),
                    message,
    ...
    override fun warningProcess(message: String, project: Project) {
        NotificationGroupManager.getInstance()
            .getNotificationGroup("LLM Execution Error")
            .createNotification(
                org.jetbrains.research.testspark.TestSparkBundle.message("llmWarningTitle"),
                message,
