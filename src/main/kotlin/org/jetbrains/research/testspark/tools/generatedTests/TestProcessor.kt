...
class TestProcessor(val project: Project) {
    ...
    private val testCompiler = TestCompiler(javaHomePath, libraryPath, getJUnitVersion())
    ...
    // TODO make common with JUnitTestsAssembler.getJUnitVersion() && LLMProcessManager.getJUnitVersion()
    private fun getJUnitVersion(): JUnitVersion = JUnitVersion.entries.toTypedArray().lastOrNull { it.name == settingsState.junitVersion } ?: JUnitVersion.JUnit4
}
