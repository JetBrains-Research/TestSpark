...
class Manager {
    companion object {
         ...
         */
//        private fun display(project: Project, result: UIContext?, numberOfUsedTool: Int) =
//            AppExecutorUtil.getAppScheduledExecutorService().execute(Display(project, result, numberOfUsedTool))
    }
}
 ...
 */
//private class Display(private val project: Project, result: UIContext?, private val numberOfUsedTool: Int) : Runnable {
...
//     */
//    private fun getMergeResult(numberOfUsedTool: Int, generationData: TestGenerationData): Report {
//        log.info("Merging $numberOfUsedTool generation results")
//
//        if (numberOfUsedTool == 1) {
//            return generationData.testGenerationResultList[0]!!
//        }
