...
import org.jetbrains.research.testspark.helpers.psiHelpers.PsiClassWrapper
...
import org.jetbrains.research.testspark.helpers.psiHelpers.PsiMethodWrapper
...
class PromptManager(
    ...
    private fun getPolymorphismRelationsWithQualifiedNames(
        ...
        val psiClassesToVisit: ArrayDeque<PsiClassWrapper> = ArrayDeque(listOf(cutPsiClass))
