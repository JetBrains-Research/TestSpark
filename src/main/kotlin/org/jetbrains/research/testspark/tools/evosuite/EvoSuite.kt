...
class EvoSuite(override val name: String = "EvoSuite") : Tool {
    ...
    override fun generateTestsForClass(project: Project, psiFile: PsiFile, caretOffset: Int, fileUrl: String?, testSamplesCode: String, runnerController: RunnerController, testSparkDisplayFactory: TestSparkDisplayFactory) {
        ...
        createPipeline(project, psiFile, caretOffset, fileUrl, runnerController, testSparkDisplayFactory).runTestGeneration(
     ...
     */
    private fun createPipeline(project: Project, psiFile: PsiFile, caretOffset: Int, fileUrl: String?, runnerController: RunnerController, testSparkDisplayFactory: TestSparkDisplayFactory): Pipeline {
        val projectClassPath: String = ProjectRootManager.getInstance(project).contentRoots.first().path
