...
class SettingsComponentTest {
    ...
    @Order(1)
    @Test
    fun checkTestSparkTabExists(remoteRobot: RemoteRobot) =
        with(remoteRobot) {
    ...
    @Order(2)
    @Test
    fun checkTestSparkInSettings(remoteRobot: RemoteRobot): Unit =
        with(remoteRobot) {
            val settingsFrame = find(SettingsFrame::class.java, timeout = Duration.ofSeconds(60))
    ...
    @Order(3)
    @Test
    fun changeTestSparkTabValues(remoteRobot: RemoteRobot): Unit =
        with(remoteRobot) {
    ...
    @Order(4)
    @Test
    fun checkEvoSuiteTabExists(remoteRobot: RemoteRobot) =
        with(remoteRobot) {
            val settingsFrame = find(SettingsFrame::class.java, timeout = Duration.ofSeconds(60))
            waitFor(Duration.ofSeconds(60)) {
    ...
    @Order(5)
    @Test
    fun checkEvoSuiteInSettings(remoteRobot: RemoteRobot): Unit =
        with(remoteRobot) {
            val settingsFrame = find(SettingsFrame::class.java, timeout = Duration.ofSeconds(60))
    ...
    @Order(6)
    @Test
    fun changeEvoSuiteTabCoverageSectionValues(remoteRobot: RemoteRobot): Unit =
        with(remoteRobot) {
            // Get previous values
            var settingsFrame = find(SettingsFrame::class.java, timeout = Duration.ofSeconds(15))
            ...
            coverageCheckBoxesList
                .zip(prevCoverageCheckBoxesValueList)
    ...
    @Order(7)
    @Test
    fun changeEvoSuiteTabGeneralSectionValues(remoteRobot: RemoteRobot): Unit =
        with(remoteRobot) {
            // Get previous values
            var settingsFrame = find(SettingsFrame::class.java, timeout = Duration.ofSeconds(15))
    ...
    @Order(8)
    @Test
    fun testIncorrectSeedDialog(remoteRobot: RemoteRobot): Unit =
        with(remoteRobot) {
            ...
            if (remoteRobot.isWin()) {
                okDialog =
                    errorDialog.button(
                        byXpath(
                            "//div[@class='CustomFrameDialogContent'][.//div[@class='Container']]//div[@class='SouthPanel']//div[@class='JButton']",
                        ),
                    )
            } else {
                okDialog =
