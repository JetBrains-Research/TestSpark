...
import org.jetbrains.research.testspark.toolwindow.PopulationLimit
import org.jetbrains.research.testspark.toolwindow.QuickAccessParametersState
import org.jetbrains.research.testspark.toolwindow.StoppingCondition
import org.jetbrains.research.testspark.uiTest.customfixtures.BasicArrowButtonFixture
import org.jetbrains.research.testspark.uiTest.customfixtures.JSpinnerFixture
import org.jetbrains.research.testspark.uiTest.pages.IdeaFrame
import org.jetbrains.research.testspark.uiTest.pages.QuickAccessParametersFixtures
...
class QuickAccessParametersTest {
     ...
     * Then opens the TestSpark sidebar on the right.
     */
    @BeforeAll
    fun setUpAll(remoteRobot: RemoteRobot): Unit = with(remoteRobot) {
        ...
        Thread.sleep(10000)
        // Open the TestSpark tool window
    ...
    fun testAdvancedSettings(): Unit = with(remoteRobot) {
        ...
        find(SettingsFrame::class.java, Duration.ofSeconds(20)).apply {
            val breadcrumbs = jLabel(byXpath("//div[@class='Breadcrumbs' and @visible_text='Tools || TestSpark || EvoSuite']"))
    ...
    /**
     * First closes the TestSpark sidebar by clicking on the stripe button again.
